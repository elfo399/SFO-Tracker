...
export type MissionSnapshotResponse = {
  statusLine: string
  sourceLabel: string
...
export async function buildMissionSnapshot(now = new Date()): Promise<MissionSnapshotResponse> {
  ...
  return {
    ...
    sourceLabel: 'Dati ufficiali NASA e JPL',
